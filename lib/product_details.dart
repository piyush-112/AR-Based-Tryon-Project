    ...
    return Container(
      ...
      child: Hero(
        ...
        child: SizedBox(
          height: 250,
          child: ModelViewer(
          src: widget.productModel.glbSource,
          ...
          Padding(
            ...
            child: Row(
              children:  <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: ((context) => ProductDetailsChanged(productModel: widget.productModel,
                      )
                      )));
                  },
                  child: Container(
                    ...
                    width: 40,
                    child: Container(
                      decoration: BoxDecoration(color: widget.productModel.extracolor, shape: BoxShape.circle),
                  ),
                ),
                ),
              ],
